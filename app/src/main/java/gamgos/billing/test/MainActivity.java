...
import gamgos.billing.test.util.GamgosIabHelper;
import gamgos.billing.test.util.IabResult;
import gamgos.billing.test.util.Inventory;
import gamgos.billing.test.util.Purchase;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHelper = new GamgosIabHelper(this, base64EncodedPublicKey);
        ...
        mHelper.startSetup(this, new GamgosIabHelper.OnIabSetupFinishedListener() {
    ...
    GamgosIabHelper.QueryInventoryFinishedListener mGotInventoryListener = new GamgosIabHelper.QueryInventoryFinishedListener() {
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        mHelper.launchPurchaseFlow(this,
                SKU_INFINITE_GAS, GamgosIabHelper.ITEM_TYPE_SUBS,
    ...
    GamgosIabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new GamgosIabHelper.OnIabPurchaseFinishedListener() {
    ...
    GamgosIabHelper.OnConsumeFinishedListener mConsumeFinishedListener = new GamgosIabHelper.OnConsumeFinishedListener() {
